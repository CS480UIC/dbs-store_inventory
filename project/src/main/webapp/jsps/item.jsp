	    ...
	    <table>
	    	<tr>
	    		<td>
				    ...
				    <a href="<c:url value='/LocationfindAll'/>" class = "btn btn-outline-primary" target="body">List Location Table</a>
				    <a href="<c:url value='/CharityfindAll'/>" class = "btn btn-outline-primary" target="body">List Charity Table</a>
					<a href="<c:url value='/LocationSimple'/>" class = "btn btn-outline-primary" target="body">Query1</a>
				    <a href="<c:url value='/CharityComplex'/>" class = "btn btn-outline-primary" target="body">Query2</a>
					<a href="<c:url value='/CharityAggregate'/>" class = "btn btn-outline-primary" target="body">Query3</a>
